...
class CreateToDoCollection implements UseCase<CollectionId,ToDoCollectionParams> {
  ...
  @override
  Future<Either<Failure, CollectionId>> call(ToDoCollectionParams params) async {
    try {
